...
extension Database {
	...
	public func addModule<T: VirtualTableModule>(_ name: String, type: T.Type) throws where T: AnyObject {
		...
		guard sqlite3_create_module_v2(databaseConnection, name, client_data.module, client_data_ptr, { client_data in
...
func init_vtab(_ db: OpaquePointer?, _ pAux: UnsafeMutableRawPointer?, _ argc: Int32, _ argv: UnsafePointer<UnsafePointer<Int8>?>?, _ ppVTab: UnsafeMutablePointer<UnsafeMutablePointer<sqlite3_vtab>?>?, _ pzErr: UnsafeMutablePointer<UnsafeMutablePointer<Int8>?>?, _ create: Bool) -> Int32 {
	...
	let vtab = sqlite3_malloc(Int32(MemoryLayout<cpipeline_sqlite3_vtab>.size))
	guard vtab != nil else {
		return SQLITE_NOMEM
	}
	...
	let vtab_ptr = vtab.unsafelyUnwrapped.bindMemory(to: cpipeline_sqlite3_vtab.self, capacity: 1)
...
func xOpen(_ pVTab: UnsafeMutablePointer<sqlite3_vtab>?, _ ppCursor: UnsafeMutablePointer<UnsafeMutablePointer<sqlite3_vtab_cursor>?>?) -> Int32 {
	return pVTab.unsafelyUnwrapped.withMemoryRebound(to: cpipeline_sqlite3_vtab.self, capacity: 1) { vtab -> Int32 in
		...
		let curs = sqlite3_malloc(Int32(MemoryLayout<cpipeline_sqlite3_vtab_cursor>.size))
		guard curs != nil else {
			return SQLITE_NOMEM
		}
		...
		let curs_ptr = curs.unsafelyUnwrapped.bindMemory(to: cpipeline_sqlite3_vtab_cursor.self, capacity: 1)
